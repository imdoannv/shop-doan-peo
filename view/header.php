...
<head>
    ...
    <title>FOODY - Bán Đồ Ăn Nhanh</title>
...
<body>
    ...
    <div class="change">
        <div class="langWrap">
            ...
            <a href="#" language='vietnamese'>VIE</a>
        </div>
    </div>
        <div class="row mb header clear">
            <div style="display: flex;justify-content: space-between;align-items: center;color: #772f2d;">
                ...
                <div style="display: flex;justify-content: space-between;align-items: center;color: #772f2d;">
                    <h2 style="font-size: 0.9vw;margin-left:65px">Hotline: 036.37.38.586</h2>
